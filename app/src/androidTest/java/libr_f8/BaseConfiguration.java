...
public class BaseConfiguration {
    ...
    public EnhancedAndroidDriver loadDriver()throws  Exception
    {
        ...
        cap.setCapability(MobileCapabilityType.APP_PACKAGE, "com.example.appcenter.sampleapp_android");
        cap.setCapability(MobileCapabilityType.APP_ACTIVITY, "com.example.appcenter.sampleapp_android.MainActivity");
